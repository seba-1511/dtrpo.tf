...
bench:
	CUDA_VISIBLE_DEVICES='' KERAS_BACKEND=tensorflow python benchmark.py -e bench --momentum 0.0 --max_path_length 5000 --timesteps_per_batch 15000 --n_iter 30 --env 'InvertedPendulum-v1' --solved 950.0
