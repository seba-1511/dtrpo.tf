...
bench:
	...
	#mpirun -n $(NREPLICAS) -x python -x plot_exp.py $(BENCH_PRE) SmallInvertedPendulum-v1 BigInvertedPendulum-v1 InvertedPendulum-v1 InvertedDoublePendulum-v1 Reacher-v1 HalfCheetah-v1 Hopper-v1 Swimmer-v1 Ant-v1 AmputedAnt-v1 BigAnt-v1 ExtendedAnt-v1 
	mpirun -n $(NREPLICAS) -x python -x plot_exp.py $(BENCH_PRE) SmallInvertedPendulum-v1 BigInvertedPendulum-v1 InvertedPendulum-v1 InvertedDoublePendulum-v1 Hopper-v1 Swimmer-v1 Ant-v1 AmputedAnt-v1 BigAnt-v1 ExtendedAnt-v1 
